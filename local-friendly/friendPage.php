...
<?php
    ...
    echo "<a href = '#'>Friend1</a>";
    echo "<br>";
    echo "<a href = '#'>Friend2</a>";
...
echo "<p>New Friend1";
echo '<form action = "accept.php" method="get"><input type="hidden" name="accept"></input> <button type="submit">Accept</button></form></p>';
echo "<br>";
echo "<p>New Friend2";
echo '<form action = "accept.php" method="get"><input type="hidden" name="accept"></input> <button type="submit">Accept</button></form></p>';
